...
@ApiModel(value="AppVersionDTO对象", description="手机APP版本管理")
@ValidateModel
public class AppVersionDTO extends AppVersionDO {

	// 说明：此model继承了AppVersionDO，controller查询使用此model接收参数，如果父类没有对应的条件属性，可在此处添加
