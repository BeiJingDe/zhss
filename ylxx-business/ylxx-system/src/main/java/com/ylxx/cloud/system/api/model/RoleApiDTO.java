...
@ApiModel(value="RoleApiDTO对象", description="角色API接口权限表")
@ValidateModel
public class RoleApiDTO extends RoleApiDO {

	// 说明：此model继承了RoleApiDO，controller查询使用此model接收参数，如果父类没有对应的条件属性，可在此处添加
