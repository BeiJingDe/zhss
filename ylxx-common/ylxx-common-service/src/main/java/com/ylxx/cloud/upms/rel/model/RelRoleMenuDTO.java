...
@ApiModel(value="RelRoleMenuDTO对象", description="角色和菜单（按钮）关联表")
@ValidateModel
public class RelRoleMenuDTO extends RelRoleMenuDO {

	// 说明：此model继承了RelRoleMenuDO，controller查询使用此model接收参数，如果父类没有对应的条件属性，可在此处添加
